...
const UI: Record<Lang, Dict> = {
  en: {
    ...
    noData: "No data here.",
    openMenu: "Open menu",
    beautifulHome: "View our beautiful home",
    showData: "Show the data",
    qualityTitle: "View our beautiful home",
    qualitySub: "How would you like to see Earth?",
    qualityUltra: "Most beautiful",
    qualityUltraDesc: "Live satellite imagery, even from far out — may load a little slower.",
    qualityFast: "Smooth & fast",
    qualityFastDesc: "Loads instantly, lighter on data.",
    aboutEyebrow: "About",
    aboutCta: "Free & open source on GitHub",
    aboutDesc: "View the code, file an idea, or make it your own.",
    aboutMadePre: "Made with",
    aboutBy: "by",
    voice: "voice",
    voices: "voices",
  ...
  es: {
    ...
    openMenu: "Abrir menú",
    beautifulHome: "Ver nuestro bello hogar",
    showData: "Mostrar los datos",
    qualityTitle: "Ver nuestro bello hogar",
    qualitySub: "¿Cómo quieres ver la Tierra?",
    qualityUltra: "Lo más bello",
    qualityUltraDesc: "Imágenes satelitales reales, incluso de lejos; puede tardar un poco más.",
    qualityFast: "Rápido y fluido",
    qualityFastDesc: "Carga al instante y usa menos datos.",
    aboutEyebrow: "Acerca de",
    aboutCta: "Gratis y de código abierto en GitHub",
    aboutDesc: "Mira el código, propón una idea o hazlo tuyo.",
    aboutMadePre: "Hecho con",
    aboutBy: "por",
    voice: "voz",
    voices: "voces",
