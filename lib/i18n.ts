...
const UI: Record<Lang, Dict> = {
  en: {
    ...
    openMenu: "Open menu",
    aboutEyebrow: "About",
    aboutBody: "Free and open source on GitHub.",
    aboutMadePre: "Made with",
    aboutMadePost: "by Nathan.",
    aboutGithub: "GitHub",
    aboutSite: "nathantowianski.com",
    voice: "voice",
    voices: "voices",
  ...
  es: {
    ...
    aboutBody: "Gratis y de código abierto en GitHub.",
    aboutMadePre: "Hecho con",
    aboutMadePost: "por Nathan.",
    aboutGithub: "GitHub",
    aboutSite: "nathantowianski.com",
    voice: "voz",
    voices: "voces",
